            ...
            <div className={` w-[160px] mx-auto relative ${props.className}`}>
                ...
                <div
                    className={` absolute left-0 top-0 bg-accent-color w-[32px] flex py-[5px] 
                                px-[10px] rounded z-20 smTablet:w-[81px] smTablet:sf-mid-14 smTablet:py-[10px] smTablet:justify-center  `}
                >
                    <p className=" sf-regular-10 text-white uppercase smTablet:sf-mid-14">
                        na
                    </p>
                </div>
                {/* sumonner name box  */}
                <input
                    ...
                    top-0 z-10 w-[160px] smTablet:w-[340px] smTablet:py-[8px] smTablet:sf-bold-15 smTablet:pl-[110px] smTablet:text-[#707070] smTablet:placeholder:text-[#707070]  ${props.searchBox}`}
                />
