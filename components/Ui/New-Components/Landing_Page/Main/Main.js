            ...
            >
                ...
                >
                    <div className=" mb-[39px] hidden smTablet:block smTablet:mb-[30px] ">
                        ...
                        <p className=" gotham-mid-30 text-light-text opacity-60 max-w-[545px] mx-auto text-center italic smTablet:text-[19px] smTablet:leading-[22px] smTablet:max-w-[342px] tablet:gotham-mid-22 tablet:max-w-[405px] ">
