...
const PlayerRow = (props) => {
    ...
    return (
        ...
        >
            ...
            {/* kda  */}
            <div>
                <h1 className={`${Classess.whiteHead} uppercase `}>2.34 kda</h1>
                <h2 className={` ${Classess.smallHead}`}>2.3/1.5/1.8</h2>
            </div>
            {/* games  */}
            <div>
                <h1 className={`${Classess.whiteHead} uppercase `}>64 %</h1>
                <h2 className={` ${Classess.smallHead}`}>19 Games</h2>
            </div>
            {/* <div
