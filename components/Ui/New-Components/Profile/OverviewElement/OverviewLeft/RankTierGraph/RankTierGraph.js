        ...
        <div className={`flex ${props.className}`}>
            <button
                className=" text-light-text font-sf-pro-text font-medium text-[9px] leading-[11px] rounded-[5px]
                              bg-buttons-gray px-[7px] py-[9px] capitalize smDesktop:text-[11px] smDesktop:leading-[13px] mr-[3px] "
            >
                Ranked solo
            </button>
            <button
                className=" text-light-text font-sf-pro-text font-medium text-[9px] leading-[11px] rounded-[5px]
                              bg-buttons-gray px-[7px] py-[9px] capitalize smDesktop:text-[11px] smDesktop:leading-[13px]"
            >
                ranked flex
            </button>
        </div>
...
const Batch = (props) => {
    return (
        <div
            className={` flex items-center justify-between mt-[14px]  ${props.className}`}
        >
            <div
...
const TierGraph = (props) => {
    return (
        <div
         ...
         smDesktop:w-full smDesktop:h-[105px] smDesktop:mt-4 `}
        >
            <Image
                src={TierGraphImg}
