...
const BuildCard = (props) => {
    return (
        ...
        >
            <h4
                className={`font-sf-pro-text text-[23px] leading-[28px] text-accent-color font-bold 
                 ${props.textStyle ? " " : ""}`}
            >
                Build
            </h4>
            <RankCard
                className={`bg-transparent flex border-transparent w-full justify-center smDesktop:mt-3 desktop:justify-start ${
                    props.mainExpand
                        ? " desktop:w-[620px] desktop:ml-[200px] "
                        : ""
                }`}
