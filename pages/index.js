		...
		>
			...
			<div className=" self-end justify-self-center w-full max-w-[580px] ">
				<div>
					...
					<h3 className={`text-white ${classes.header}`}>League Of Legends</h3>
				</div>
				<p className={`${classes.title} mx-auto flex flex-col `}>
					...
					<span>something in between, there’s a spot for you on the Rift.</span>
				</p>
				...
				<div className={`${classes.highlight} relative `}>
					...
					<div className={`${classes.row} mb-9 w-[470px] ml-6 `}>
						<h4 className={`${classes.header} ${classes.sm_header}`}>
							what make us <span className=" text-white-blue">different?</span>{" "}
						</h4>
