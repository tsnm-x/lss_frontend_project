                ...
                <div className=" self-end justify-self-center w-full max-w-[580px] ">
                    <div>
                        <h3 className={`text-white ${classes.header}`}>
                            Experience{" "}
                            <span className="text-blue-700">The Ultimate</span>{" "}
                            Simulator
                        </h3>
                        <h3 className={`text-white ${classes.header}`}>
                            League Of Legends
                    ...
                    <p className={`${classes.title} mx-auto flex flex-col `}>
                        <span>
                            Whether you like to dive straight into the fray,
                            support your teammates, or
                        </span>
                        <span>
                            something in between, there’s a spot for you on the
                            Rift.
                        </span>
                    </p>
                ...
                <div className=" container max-w-[580px] justify-self-center self-end ">
                    <div className={`${classes.highlight} relative `}>
                        ...
                        <div className={`${classes.row} mb-9 w-[470px] ml-6 `}>
                            <h4
                                className={`${classes.header} ${classes.sm_header}`}
                            >
                                what make us{" "}
